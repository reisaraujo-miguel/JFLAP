...
import javax.swing.*;
import java.io.*;
// SVG export temporarily disabled for Java compatibility
...
public class ExportAction extends RestrictedAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JOptionPane.showMessageDialog(c,
            "SVG export is temporarily disabled due to Java version compatibility issues.\n" +
            "Please use image export formats (PNG, JPG, etc.) instead.",
            "SVG Export Disabled", JOptionPane.INFORMATION_MESSAGE);
