...
public class ExportAction extends RestrictedAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            // Set SVG canvas size
            svgGenerator.setSVGCanvasSize(new Dimension(comp.getWidth(), comp.getHeight()));

            // Paint the component to SVG
            ...
            while (result == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(c,
                        "SVG export completed successfully!",
            ...
            JOptionPane.showMessageDialog(c,
                ...
                "SVG Export Failed", JOptionPane.ERROR_MESSAGE);
        }
    }
